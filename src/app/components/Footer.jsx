        ...
        <footer className="z-50 text-center shadow-ylg bg-textured2  lg:text-left">
            <div className="flex border-b-2 justify-end border-black p-3">
                ...
                <div className="flex gap-x-6 pt-2 justify-center">
                    ...
                    <a href='https://www.instagram.com/casuallegendsai' className="cursor-pointer hover:text-teal-500">
                        <svg
                    ...
                    <a href='https://twitter.com/CasualLegendsAI' className="cursor-pointer hover:text-teal-500">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-4 w-4"
                            fill="currentColor"
                    ...
                    <a href='https://discord.gg/AAuyPtySpr' className="cursor-pointer -mr-2 hover:text-teal-500">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-6 w-6"
                            fill="currentColor"
                    ...
                    <a href='https://www.linkedin.com/company/casual-legends/' className=" cursor-pointer hover:text-teal-500">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-4 w-4"
                            fill="currentColor"
                ...
                <div className="grid-1 grid gap-8 lg:grid-cols-5">
                    ...
                    <div className="">
                        ...
                        <ul className="flex flex-col ">
                            ...
                            <li>
                                <Link href="/terms" className="hover:text-teal-500">Terms of Service</Link>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="flex flex-col space-y-4">
                            ...
                            <li>
                                <a href="https://www.coze.com/store/bot/7347237232354574341" className="hover:text-teal-500">Coze</a>
                            </li>
                            <li>
                                <a href="https://poe.com/CasualLegends" className="hover:text-teal-500">Poe</a>
                            </li>
                        </ul>
                    </div>
                    {/* <!-- Contact section --> */}
